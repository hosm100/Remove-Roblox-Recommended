...
## How to use
1. Download the first zip file in [releases](https://github.com/hosm100/Remove-Roblox-Recommended/releases/download/Release/)) and extract/unpack it in a suitable folder.
